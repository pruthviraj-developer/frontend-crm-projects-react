...
export const PinCodeMobile: FC<IPinCodeProps> = ({ productId, pinCode, closePinCodePopup }: IPinCodeProps) => {
  ...
  const [pincode, setPinCode] = useState<string>(setFormatedValue(pinCode, pinCode) || '');
    ...
    <PinCodeWrapper>
      ...
      <PinCodeContainer>
        ...
        >
          ...
          <PinCodeSubmit disabled={pincode.length < 7 || isLoading} type="submit">
            Check
          </PinCodeSubmit>

...
export const DeliveryDetailsDesktop: FC<IDeliveryDetailsProps> = ({
  deliveryMessages,
  ...
  return (
    <DeliveryDetailsWrapper>
      ...
      <DeliveryDetailsContent>
        ...
        {deliveryMessages &&
          deliveryMessages.map((data: IProductDetailsDeliveryMessageOrDeliveryMessagesEntity, index: number) => (
            <Delivery key={index}>

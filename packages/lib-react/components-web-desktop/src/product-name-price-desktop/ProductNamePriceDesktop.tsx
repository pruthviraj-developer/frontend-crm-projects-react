...
import { IProductNamePricePropsDesktop } from './IProductNamePriceDesktop';

const getFormattedPrice = (price?: number) => {
  return price && price.toLocaleString('en-IN');
};
export const ProductNamePriceDesktop: FC<IProductNamePricePropsDesktop> = ({
  productName,
  retailPrice,
  retailPriceMax,
  regularPrice,

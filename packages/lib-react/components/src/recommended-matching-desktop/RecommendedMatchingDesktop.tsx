...
import { IRecommendedMatchingPropsDesktop } from './IRecommendedMatchingDesktop';
import {
...
export const RecommendedMatchingDesktop: FC<IRecommendedMatchingPropsDesktop> =
  ({ section, product }: IRecommendedMatchingPropsDesktop) => {
    let subSection = 'More';
    const brand = 'Brand',
      category = 'Category',
      colour = 'Colour';

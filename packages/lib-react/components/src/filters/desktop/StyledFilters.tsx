...
const ToggleIcon = styled(SvgIcon)<{ isFirst?: number; active?: boolean }>`
  display: ${(props) =>
    props.isFirst ? (props.active ? 'block' : 'none') : 'block'};
...
const FilterSection = styled.div<{
  ...
  border-bottom: 1px solid ${Colors.MERCURY};
  padding-top: ${(props) => (props.isFirst ? 0 : 12)}px;
  padding-bottom: ${(props) => (props.isAccordionActive ? 12 : 0)}px;
`;
